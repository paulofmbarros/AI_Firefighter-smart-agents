...
public class Vehicles_aircraftAgent extends VehiclesAgent { // MUDAR AQUI
	/**
	 * 
	 */
	private static final long serialVersionUID = 1L;
	private static final String vehicleEnum = "AIRCRAFT"; // MUDAR AQUI
	
	public Vehicles_aircraftAgent(){ //MUDAR AQUI
		isAvailable=true;
		coordX=200;
		coordY=200;
		waterTank = maxWater = Configurations.AIRCRAFT_MAX_WATER_TANK_CAPACITY; // MUDAR AQUI
		fuelTank = maxFuel = Configurations.AIRCRAFT_MAX_FUEL_TANK_CAPACITY;  // MUDAR AQUI
				
		speed = (Configurations.BASE_VEHICLE_SPEED * Configurations.AIRCRAFT_SPEED_MULTIPLIER); // MUDAR AQUI
	...
	class ReceiveMessages extends CyclicBehaviour {
		...
		public void action() {
			...
			if(msg == null || msg.getOntology() == "info-aircraft") {
				block();
				return;
			}
