...
public class Vehicles_firetruckAgent extends VehiclesAgent { // MUDAR AQUI
	/**
	 * 
	 */
	private static final long serialVersionUID = 1L;
	private static final String vehicleEnum = "FIRETRUCK"; // MUDAR AQUI
	
	public Vehicles_firetruckAgent(){ //MUDAR AQUI
		isAvailable=true;
		coordX=350;
		coordY=350;
		waterTank = maxWater = Configurations.FIRE_TRUCK_MAX_WATER_TANK_CAPACITY; // MUDAR AQUI
		fuelTank = maxFuel = Configurations.FIRE_TRUCK_MAX_FUEL_TANK_CAPACITY;  // MUDAR AQUI
				
		speed = (Configurations.BASE_VEHICLE_SPEED * Configurations.FIRETRUCK_SPEED_MULTIPLIER); // MUDAR AQUI
	...
	class InformInterfaceBehaviour extends OneShotBehaviour {
		...
		public void action() {
			...
			msg.setOntology("info-firetruck");
	...
	class ReceiveMessages extends CyclicBehaviour {
		...
		public void action() {
			...
			if(msg == null || msg.getOntology() == "info-firetruck") {
				block();
				return;
			}
